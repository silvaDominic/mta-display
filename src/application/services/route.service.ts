...
const STUB_ROUTE_INFO = [
  new ArrivalInfoModel(fakeId(), TRAIN_LINE.G, Date.now(), Date.now() + 10, 'Church Ave', DIRECTION.S),
  new ArrivalInfoModel(fakeId(), TRAIN_LINE.G, Date.now(), Date.now() + 10, 'Court St', DIRECTION.N),
  new ArrivalInfoModel(fakeId(), TRAIN_LINE.G, Date.now(), Date.now() + 10, 'Court St', DIRECTION.N),
  new ArrivalInfoModel(fakeId(), TRAIN_LINE.G, Date.now(), Date.now() + 10, 'Church Ave', DIRECTION.S),
  new ArrivalInfoModel(fakeId(), TRAIN_LINE.G, Date.now(), Date.now() + 10, 'Church Ave', DIRECTION.S),
  new ArrivalInfoModel(fakeId(), TRAIN_LINE.G, Date.now(), Date.now() + 10, 'Court St', DIRECTION.N),
